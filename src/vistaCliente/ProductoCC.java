 ...
 * @author pc
 */
public class ProductoCC extends javax.swing.JFrame {

    /**
     * Creates new form ProductoCC
     */
    int indice;
    int x,y;
    public ProductoCC() {
    ...
    private void initComponents() {
        ...
        jComboBox1.setBackground(new java.awt.Color(255, 166, 41));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Comprar frmEdit_Add = new Comprar();
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoCC().setVisible(true);
            }
        });
    }
